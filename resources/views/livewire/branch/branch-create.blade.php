    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="mb-10 text-center sm:text-left">
            ...
            <p class="mt-2 text-lg text-gray-600 dark:text-gray-400">
                {{ __('Add a new branch to your business') }}
            </p>
        ...
        <div
            ...
            <div class="px-6 py-8 sm:p-10">
                ...
                @if (session('success'))
                    <div
                        class="mb-8 p-4 rounded-lg bg-green-50 border border-green-200 text-green-800 dark:bg-green-900/30 dark:border-green-800/50 dark:text-green-200">
                        {{ session('success') }}
                    </div>
                @endif
                ...
                <form wire:submit.prevent="save" class="space-y-8">
                    ...
                    <div>
                        ...
                        <input id="name" type="text" wire:model.live.debounce.500ms="name"
                            ...
                            placeholder="{{ __('Main Branch / Downtown Store / etc.') }}" required />
                        @error('name')
                    ...
                    <div>
                        ...
                        <input id="location" type="text" wire:model.live.debounce.500ms="location"
                            class="block w-full rounded-lg border-gray-300 px-4 py-3.5 text-base
                                   shadow-sm focus:border-indigo-500 focus:ring-indigo-500
                                   dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400"
                            placeholder="{{ __('Dar es Salaam, Kariakoo / Mwanza, Nyamagana / etc.') }}" />
                        @error('location')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="flex items-center gap-3">
                        <input id="is_main" type="checkbox" wire:model.live="is_main"
                            class="h-5 w-5 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600" />
                        <label for="is_main" class="text-base font-medium text-gray-700 dark:text-gray-300">
